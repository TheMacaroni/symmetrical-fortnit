...
# Webdriver
browser = webdriver.Chrome("C:/Users/Computador/Downloads/q saco velho preguica de criar pasta/chromedriver.exe")
...
for index, row in planet_df_1.iterrows():
    ...
    print(f"Coleta de dados do Hyperlink {index+1} concluída -- https://www.youtube.com/@-Macaroni") 
